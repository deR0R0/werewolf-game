...
@onready var R2_Margaret_Dialogue = load("res://Dialogues/debug.dialogue")

@onready var R1_Alan_Dialogue = load("res://Dialogues/debug.dialogue")
@onready var R2_Alan_Dialogue = load("res://Dialogues/debug.dialogue")

@onready var R1_Selene_Dialogue = load("res://Dialogues/debug.dialogue")
@onready var R2_Selene_Dialogue = load("res://Dialogues/debug.dialogue")

@onready var R1_Theodore_Dialogue = load("res://Dialogues/debug.dialogue")
@onready var R2_Theodore_Dialogue = load("res://Dialogues/debug.dialogue")
